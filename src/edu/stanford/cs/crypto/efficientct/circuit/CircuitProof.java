...
public class CircuitProof<T extends GroupElement<T>> extends RangeProof<T> {
    ...
    public CircuitProof(T ai, T ao, T s, GeneratorVector<T> tCommits, BigInteger tauX, BigInteger mu, BigInteger t, InnerProductProof<T> productProof, BigInteger alpha) {
