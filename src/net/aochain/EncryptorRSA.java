...
public class EncryptorRSA {
	/**
	 * When files are encrypted, this will be appended to the end of the filename.
	 */
	private static final String ENCRYPTED_FILENAME_SUFFIX = ".encrypted";

	/**
	 * When files are decrypted, this will be appended to the end of the filename.
	 */
	...
	public byte[] encryptOAEP(PublicKey key, byte[] plaintext) throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException, IllegalBlockSizeException, BadPaddingException
	{
	...
	public byte[] decryptOAEP(PrivateKey key, byte[] ciphertext) throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException, IllegalBlockSizeException, BadPaddingException
	{
	    Cipher cipher = Cipher.getInstance("RSA/ECB/OAEPWithSHA1AndMGF1Padding");   
	...
	/**
	 * Encrypt the given file with a session key encrypted with an RSA public key
	 * which will be read in from the filesystem.
	 */
	...
	/**
	 * Decrypt the given file. Start by getting the RSA private key and decrypting
	 * the session key embedded in the file. Then decrypt the file with that session
	 * key.
	 */
	...
	/**
	 * Utility method to encrypt a byte array with a given password. Salt will be
	 * the first 8 bytes of the byte array returned.
	 */
	...
	/**
	 * Utility method to decrypt a byte array with a given password. Salt will be
	 * the first 8 bytes in the array passed in.
	 */
